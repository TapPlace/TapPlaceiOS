...
class OnBoardingViewController: UIViewController {
    ...
    let images = [UIImage(named: "onboarding_image_1"), UIImage(named: "onboarding_image_2"), UIImage(named: "onboarding_image_3")]
...
extension OnBoardingViewController: UIScrollViewDelegate, BottomButtonProtocol{
    func didTapBottomButton() {
        ...
        if buttonText == "건너뛰기" {
            ...
            let setUser = UserModel(uuid: Constants.keyChainDeviceID, isFirstLaunch: false)
